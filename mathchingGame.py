...
def draw_backgrounds():
    ...
    restart_button = pygame.draw.rect(
        screen, gray, [10, HEIGHT - 90, 200, 80], 0, 5)
...
while running:
    ...
    if matches == rows * cols // 2:
        ...
        winner_text = title_font.render(
            f'You Won in {score} moves!', True, white)
    ...
    if first_guess:
        ...
        location = (first_guess_num // rows * 75 + 18,
    ...
    if second_guess:
        ...
        location = (second_guess_num // rows * 75 + 18,
